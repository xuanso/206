...
def get_parser():
    ...
    # data
    parser.add_argument('--data_path', type=str, default='./data/province/train_joint.npy')
    parser.add_argument('--label_path', type=str, default='../data/uav/province/train_label.npy')
